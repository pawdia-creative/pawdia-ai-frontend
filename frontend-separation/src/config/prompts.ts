...
export const stylePrompts: StylePrompt[] = [
  ...
  },
  {
    ...
    promptTemplate:
      "Transform this pet photo into an authentic, translucent watercolor painting while STRICTLY preserving the original content and composition. " +
      "Hard constraints: do NOT rotate or flip the image; keep the same camera angle, framing and composition. " +
      "KEEP the pet's breed, posture, proportions, head angle, expression, fur color, markings and accessories exactly the same as the original photo. " +
      "Preserve the main background structure, perspective and light direction — convert the rendering only into watercolor treatment. " +
      "Rendering instructions (use these keywords): wet-on-wet blending, translucent layered washes, soft edge diffusion, pigment granulation, subtle backruns and blooms, natural color bleeding at edges, lifted highlights, paper texture (cold-pressed watercolor paper), soft watercolor halos, gentle color gradients, hand‑made watercolor look. " +
      "Keep colors fresh and elegant with controlled saturation; simplify and soften background details but keep depth and relationship to the subject. " +
      "Optional add-on for texture: overlay visible watercolor paper grain and slight paper warp for authenticity.",
    negativePrompt:
      "blurry, low quality, rotated, flipped, changed composition, different pose, different background, scene replaced, cartoon, anime, oil painting, hard digital edges, over-sharpened, CGI, plastic texture, opaque colors, heavy impasto, abstract, distorted features, deformed body, extra limbs, missing limbs, photorealistic skin pores",
    parameters: {
      steps: 32,
      cfgScale: 6.5,
      sampler: "DPM++ 2M Karras",
